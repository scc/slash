...
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('.*first.*post.*','comments','gi','postersubj',0.0000,0,0,'What do you want? A medal?',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(?:\\s+)','comments','gi','postersubj',0.0000,7,0,'Lots of space in the subject ... lots of space in the head.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(?:\\s+)','comments','gi','postercomment',0.0000,40,0,'Lots of space in the comment ... lots of space in the head.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('(?:(?:\\W){5,})','comments','gi','postercomment',0.0000,5,25,'Junk character post.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('(?:\\b(?:[^a-zA-Z0-9])+\\b)','comments','gi','postercomment',0.0000,10,10,'Junk character post.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('(?:\\b(?:[^a-zA-Z0-9])+\\b)','comments','gi','postersubj',0.0000,10,0,'Junk character post.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(.)\\1{5,}$','comments','gi','postersubj',0.0000,0,0,'Junk character post.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(?:.)$','comments', 'gi','postersubj',0.0000,0,0,'One character. Hmmm. Gee, might this be a troll?',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(?:.)$','comments', 'gi','postercomment',0.0000,0,0,'One character. Hmmm. Gee, might this be a troll?',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('[\\\\\\,\\.\\-\\_\\*\\|\\}\\{\\]\\[\\@\\&\\%\\$\\s\\)\\(\\?\\!\\^\\=\\+\\~\\`\\\"\\\']','comments', 'gi','postercomment',0.6000,0,10,'Ascii art. How creative. Not here though.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('[^a-zA-Z0-9]','comments', 'gi','postercomment',0.6000,0,10,'Ascii Art. How creative. Not here though.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('[^a-zA-Z0-9]','comments', 'gi','postersubj',0.6000,0,10,'Ascii Art. How creative. Not here though.',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('[^a-z]','comments', 'g','postercomment',0.5000,0,2,'PLEASE DON\'T USE SO MANY CAPS. USING CAPS IS LIKE YELLING!',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('[^a-z]','comments', 'g','postersubj',0.5000,0,2,'PLEASE DON\'T USE SO MANY CAPS. USING CAPS IS LIKE YELLING!',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(?:)$','comments', 'gi','postersubj',0.0000,0,0,'Cat got your tongue? You mean you have nothing to say?',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('^(?:)$','comments', 'gi','postercomment',0.0000,0,0,'Cat got your tongue? You mean you have nothing to say?',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('\\w{80}','comments', '','postersubj',0.0000,0,0,'that\'s an awful long string of letters there!',0);
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message, maximum_length) VALUES ('\\w{80}','comments', '','postercomment',0.0000,0,0,'that\'s an awful long string of letters there!',0);
