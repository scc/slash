...
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('(?:\\b(?:[^a-zA-Z0-9])+\\b)','comments','gi','postersubj',0.0000,10,0,'Junk character post.');
...
INSERT INTO content_filters (regex, form, modifier, field, ratio, minimum_match, minimum_length, err_message) VALUES ('[^a-z]','comments', 'g','postersubj',0.5000,0,2,'PLEASE DON\'T USE SO MANY CAPS. USING CAPS IS LIKE YELLING!');
...
INSERT INTO vars (name, value, description) VALUES ('m2_dissention_penalty', '-1', 'Penalty assessed for each "head" of dissention when M2 penalties are triggered.');
...
INSERT INTO vars (name, value, description) VALUES ('m2_minority_trigger', '0.05', 'If weighted average of dissention votes to consensus votes is less than this value, this will trigger M2 penalties.');
