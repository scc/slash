...
B<Note>: For slashd (see F<utils/slashd>, which starts slashd),
...
B<Note>: All of the installation steps below should be executed as root.
...
So, for example, you might type:
	...
	make INIT=/etc PREFIX=/home/slash
