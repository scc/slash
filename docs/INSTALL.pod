...
This document describes how to install Slash 2.1/2.2.  For instructions on
...
might not be appropriate for your site).  At least give ???
...
=head2 Slash 2.0 -> Slash 2.1/2.2

These procedures do not yet exist.  See L<README>.
