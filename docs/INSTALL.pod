...
Slash can always be downloaded from SourceForge, from the FTP site,
and via CVS.
...
See the SourceForge page for patches and bug reports.
...
run C<make test> after installing here, and then installing the Perl
