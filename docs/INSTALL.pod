...
F<$PREFIX/slash.conf>.  You can put its contents into your httpd.conf,
or you can just C<Include> it in your httpd.conf.
...
file will be created at F<$PREFIX/$SITENAME/$SITENAME.conf>.  You can
put its contents unto your httpd.conf, or you can just C<Include> it in
your httpd.conf.
