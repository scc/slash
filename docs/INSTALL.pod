...
This document describes how to install Slash 2.0
...
PostgreSQL support in Slash 2.0 is currently alpha-quality,
...
=item Slash 2.0.0-pre1 -E<gt> Slash-2.0.0 release
...
Also, "journal_user_count" is no longer in use and may be deleted.

See F<plugins/Journal/dump>.
...
=item Slash 2.0.0-pre2 -E<gt> Slash 2.0.0
...
=item plugins/Journal/templates/pagination;journal;default

=item plugins/Search/templates/pagination;search;default

=item themes/slashcode/templates/dispLinkComment;misc;default
...
=item plugins/Journal/templates/journalitem;journal;default

=item plugins/Search/templates/linksearch;search;default
...
building, for Compress::Zlib and XML::Parser.  See L<"perl">.
...
When it is installing the DBIx::Password module, it will ask for
some information.  Give the info for accessing the Slash database created
in step 1.  This is your B<virtual user> information; it is a single
name that is used to refer to a configuration for connecting to your
database.

If you have problems, feel free to re-run "install Bundle::Slash".  It
