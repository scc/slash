...
=head1 How do I get my theme into the install system?
...
=head1 What does my theme need to make it work with the install?
...
=head1 I have a really cool theme and I would like to see it added to the Slash
