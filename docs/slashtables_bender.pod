=head1 Tables in slashdot  

The following is a listing of tables that make up the slashdot schema. Some, or all ofthe data in a table is displayed, where feasable, to give a better idea of a table's purpose. 
...
the actual contents of the block. This can be eval code,
...
datestamphost_name - where they're coming from. 
...
true/falseissue - true/false extras - true/false 
...
status code determines how often static page is re-writen.
...
number of unfair meta-moderationss
...
number of stories that appearnoboxes - 1 or 0 boxes or not
...
usestzcode table. Your time zone table 
