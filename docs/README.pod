...
There are currently B<NO> upgrade procedures in place for previous
versions of Slash.  Those will be coming in a subsequent beta.
...
The layout and description of the database.  [There are out of date.]
