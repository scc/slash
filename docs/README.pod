...
We need docs for schema, upgrading.  We need to upgrade
the Getting Started doc.  We need to have docs on how to
do a plugin or theme.  Anything else?
...
GNU General Public License for more details (F<COPYING>).

You should have received a copy of the GNU General Public License
along with Slash; if not, go to http://www.fsf.org/
