...
that get installed from the Makefile.
# add them to what list in which Makefile?  do you mean the
# Makefile for the plugin? -- pudge
...
see your plugin. The following are the keywords it knows:
# What is the syntax of the file? -- pudge
...
Use the install-plugin tool.
# Give basic directions on how to use it; perhaps an example or two,
# and then a place to look for more information. -- pudge
